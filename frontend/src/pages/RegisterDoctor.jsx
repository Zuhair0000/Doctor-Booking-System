...
const RegisterDoctor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:3001/api/auth/registerdoctor", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ name, email, password, specialization, bio }),
      });
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows="4"
                  className="block w-full border border-gray-300 rounded-lg p-2"
                  placeholder="Tell patients about your experience, education, and specialties..."
                ></textarea>
              </div>
              {errors.password && (
                <p className="mt-1 text-sm text-red-600">{errors.password}</p>
